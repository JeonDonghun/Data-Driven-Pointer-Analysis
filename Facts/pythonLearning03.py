...
def oneMimimalLearning (backUpFormula,startFormula,bestCost,bestPrecision,cmd,dooppath,changed):
  ...
  os.system('bloxbatch -db ../doop/last-analysis -query ProvenCast | sort > ChangedAlarm_Numluindex.facts')
  ...
  if(analysisTime == 'timeout'):
    ...
    os.system('cp backupantlr.facts ChangedAlarm_Numantlr.facts') 
    return backUpFormula
  os.system('bloxbatch -db ../doop/last-analysis -query ProvenCast | sort > ChangedAlarm_Numlusearch.facts')
  ...
  if(analysisTime == 'timeout'):
    ...
    os.system('cp backupantlr.facts ChangedAlarm_Numantlr.facts') 
    return backUpFormula
  os.system('bloxbatch -db ../doop/last-analysis -query ProvenCast | sort > ChangedAlarm_Numpmd.facts')
  ...
  if(analysisTime == 'timeout'):
    ...
    os.system('cp backupantlr.facts ChangedAlarm_Numantlr.facts') 
    return backUpFormula
  os.system('bloxbatch -db ../doop/last-analysis -query ProvenCast | sort > ChangedAlarm_Numantlr.facts')
...
os.system('cp ../doop/logic/depth0and3.logic ../doop/logic/context-sensitive.logic')
...
dooppath = '../doop/'
analysisTime = runDoop (cmd,dooppath)
os.system('bloxbatch -db ../doop/last-analysis -query ProvenCast | sort > luindexAlarm_Num.facts')
#time out check do!
...
cmd = 'run -jre1.6 3-object-sensitive+3-heap jars/dacapo/lusearch.jar'
analysisTime = runDoop (cmd,dooppath)
os.system('bloxbatch -db ../doop/last-analysis -query ProvenCast | sort > lusearchAlarm_Num.facts')

timeRepository = timeRepository + float(analysisTime)

cmd = 'run -jre1.6 3-object-sensitive+3-heap jars/dacapo/pmd.jar'
analysisTime = runDoop (cmd,dooppath)
os.system('bloxbatch -db ../doop/last-analysis -query ProvenCast | sort > pmdAlarm_Num.facts')

timeRepository = timeRepository + float(analysisTime)

cmd = 'run -jre1.6 3-object-sensitive+3-heap jars/dacapo/antlr.jar'
analysisTime = runDoop (cmd,dooppath)
os.system('bloxbatch -db ../doop/last-analysis -query ProvenCast | sort > antlrAlarm_Num.facts')
...
for i in range(0,len(startFormula)):
  for util in range(0,len(startFormula[i])): 
    ...
    for j in range(0,len(startFormula[i])):
      if(bestPrecision>3400):
      #if(bestPrecision>3353):
        break
      print(startFormula[i])
      print("cache")
      ...
      if(bestPrecision > precisionRepository+4):

...
public class FactGenerator
{
  ...
  {
    int methodCnt = c.getMethodCount();
    _writer.writeClassMethodCounts(c, methodCnt);
  ...
  {
     SootClass methodClass = m.getDeclaringClass();
     _writer.writeDeclaringClass(m, methodClass);

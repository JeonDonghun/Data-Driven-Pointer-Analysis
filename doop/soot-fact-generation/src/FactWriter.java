...
public class FactWriter
{
  ...
  public void writeClassMethodCounts(SootClass c, int i)
  { 
    String rep = _rep.type(c);
    _db.add("ClassMethodCounts", 
      _db.addEntity("ClassType", rep),
      _db.asIntColumn(_rep.index(i)));
  }

  public void writeDeclaringClass(SootMethod m,SootClass c)
  {
    String rep = _rep.type(c);
    _db.add("MethodDeclaringClass",
  ...
  public void myAssignStmt(SootMethod inMethod/*, InvokeExpr expr, Session session*/){
    _db.add("AssignStmtInMeth",
                _db.asEntity(_rep.method(inMethod)));
  }public void myIdentityStmt(SootMethod inMethod/*, InvokeExpr expr, Session session*/){
    _db.add("IdentityStmtInMeth",
                _db.asEntity(_rep.method(inMethod)));
  }public void myInvokeStmt(SootMethod inMethod/*, InvokeExpr expr, Session session*/){
    _db.add("InvokeStmtInMeth",
                _db.asEntity(_rep.method(inMethod)));
  }public void myReturnStmt(SootMethod inMethod/*, InvokeExpr expr, Session session*/){
    _db.add("ReturnStmtInMeth",
                _db.asEntity(_rep.method(inMethod)));
  }public void myThrowStmt(SootMethod inMethod/*, InvokeExpr expr, Session session*/){
    _db.add("ThrowStmtInMeth",
                _db.asEntity(_rep.method(inMethod)));
  }public void myBreakpointStmt(SootMethod inMethod/*, InvokeExpr expr, Session session*/){
    _db.add("BreakpointStmtInMeth",
                _db.asEntity(_rep.method(inMethod)));
  }public void myEnterMonitorStmt(SootMethod inMethod/*, InvokeExpr expr, Session session*/){
    _db.add("EnterMonitorStmtInMeth",
                _db.asEntity(_rep.method(inMethod)));
  }public void myExitMonitorStmt(SootMethod inMethod/*, InvokeExpr expr, Session session*/){
    _db.add("ExitMonitorStmtInMeth",
                _db.asEntity(_rep.method(inMethod)));
  }public void myGotoStmt(SootMethod inMethod/*, InvokeExpr expr, Session session*/){
    _db.add("GotoStmtInMeth",
                _db.asEntity(_rep.method(inMethod)));
  }public void myIfStmt(SootMethod inMethod/*, InvokeExpr expr, Session session*/){
    _db.add("IfStmtInMeth",
                _db.asEntity(_rep.method(inMethod)));
  }public void myLookupStmt(SootMethod inMethod/*, InvokeExpr expr, Session session*/){
    _db.add("LookupStmtInMeth",
                _db.asEntity(_rep.method(inMethod)));
  }public void myNopStmt(SootMethod inMethod/*, InvokeExpr expr, Session session*/){
    _db.add("NopStmtInMeth",
                _db.asEntity(_rep.method(inMethod)));
  }public void myRetStmt(SootMethod inMethod/*, InvokeExpr expr, Session session*/){
    _db.add("RetStmtInMeth",
                _db.asEntity(_rep.method(inMethod)));
  }public void myReturnVoidStmt(SootMethod inMethod/*, InvokeExpr expr, Session session*/){
    _db.add("ReturnVoidStmtInMeth",
                _db.asEntity(_rep.method(inMethod)));
  }public void myTableSwitchStmt(SootMethod inMethod/*, InvokeExpr expr, Session session*/){
    _db.add("TableSwitchStmtInMeth",
                _db.asEntity(_rep.method(inMethod)));
  }
}

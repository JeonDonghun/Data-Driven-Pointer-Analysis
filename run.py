...
ANALYSIS={
    #'data2':'3-object-sensitive+2-heap+Data',
    'data2':'3-object-sensitive+2-heap+Data',
    #'data2':'Targetted',
    'data1':'2-object-sensitive+heap+Data',
...
PROGRAM=[
    'batik', 'checkstyle', 'sunflow', 'findbugs', 'jpc','luindex','antlr','pmd',
    'eclipse', 'chart', 'fop', 'xalan', 'bloat','jedit','briss','lusearch','hsqldb','jython',
]

DACAPO=['antlr', 'pmd', 'eclipse', 'chart', 'fop', 'xalan', 'bloat','lusearch','hsqldb','jython','luindex' ]
